...
const attachmentVariants = cva(
    'group/attachment bg-card text-card-foreground focus-within:ring-ring/30 has-[>a,>button]:hover:bg-muted/50 data-[state=error]:border-destructive/30 relative flex w-fit max-w-full min-w-0 shrink-0 flex-wrap rounded-3xl border transition-colors focus-within:ring-1 data-[state=idle]:border-dashed',
    {
        variants: {
            orientation: {
